...
import { signOutAction } from "@/app/(auth)/actions"; // Import the server action
    ...
    <>
      ...
      >
        <SheetContent side="left" className="p-3 w-80 bg-muted">
          <SheetHeader>
            <VisuallyHidden.Root>
              <SheetTitle className="text-left">سجل المحادثات</SheetTitle>
          ...
          <div className="text-sm flex flex-row items-center justify-between">
            <div className="flex flex-row gap-2">
              <div className="dark:text-zinc-300">سجل المحادثات</div>
            ...
            {user && (
              <>
                <form
                  ...
                  action={signOutAction} // Use the imported server action
                >
                  <Button
                    type="submit"
                    variant="ghost"
                    className="w-full justify-start font-normal text-sm text-red-500 hover:bg-red-500/10 hover:text-red-500"
                  >
                    Sign out
                  </Button>
                </form>
